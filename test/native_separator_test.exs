defmodule NativeSeparatorTest do
  ...
  describe "integer separator" do
    test "parse_string_with_config accepts integer separator" do
      assert RustyCSV.Native.parse_string_with_config(@csv, 44, 34) == @expected
    end

    test "parse_string_fast_with_config accepts integer separator" do
      assert RustyCSV.Native.parse_string_fast_with_config(@csv, 44, 34) == @expected
    end

    test "parse_string_indexed_with_config accepts integer separator" do
      assert RustyCSV.Native.parse_string_indexed_with_config(@csv, 44, 34) == @expected
    end

    test "parse_string_parallel_with_config accepts integer separator" do
      assert RustyCSV.Native.parse_string_parallel_with_config(@csv, 44, 34) == @expected
    end

    test "parse_string_zero_copy_with_config accepts integer separator" do
      assert RustyCSV.Native.parse_string_zero_copy_with_config(@csv, 44, 34) == @expected
    end

    test "streaming_new_with_config accepts integer separator" do
      parser = RustyCSV.Native.streaming_new_with_config(44, 34)
  ...
  describe "integer tab separator" do
    test "parse_string_with_config accepts tab as integer 9" do
      assert RustyCSV.Native.parse_string_with_config(@tsv, 9, 34) == @expected
    end

    test "parse_string_fast_with_config accepts tab as integer 9" do
      assert RustyCSV.Native.parse_string_fast_with_config(@tsv, 9, 34) == @expected
    end

    test "parse_string_indexed_with_config accepts tab as integer 9" do
      assert RustyCSV.Native.parse_string_indexed_with_config(@tsv, 9, 34) == @expected
    end

    test "parse_string_parallel_with_config accepts tab as integer 9" do
      assert RustyCSV.Native.parse_string_parallel_with_config(@tsv, 9, 34) == @expected
    end

    test "parse_string_zero_copy_with_config accepts tab as integer 9" do
      assert RustyCSV.Native.parse_string_zero_copy_with_config(@tsv, 9, 34) == @expected
    end
  ...
  describe "list-of-binaries separator" do
    test "parse_string_with_config accepts list of binaries" do
      assert RustyCSV.Native.parse_string_with_config(@multi_csv, [<<44>>, <<59>>], 34) ==
               @multi_expected
    end

    test "parse_string_fast_with_config accepts list of binaries" do
      assert RustyCSV.Native.parse_string_fast_with_config(@multi_csv, [<<44>>, <<59>>], 34) ==
               @multi_expected
    end

    test "parse_string_indexed_with_config accepts list of binaries" do
      assert RustyCSV.Native.parse_string_indexed_with_config(@multi_csv, [<<44>>, <<59>>], 34) ==
               @multi_expected
    end

    test "parse_string_parallel_with_config accepts list of binaries" do
      assert RustyCSV.Native.parse_string_parallel_with_config(@multi_csv, [<<44>>, <<59>>], 34) ==
               @multi_expected
    end

    test "parse_string_zero_copy_with_config accepts list of binaries" do
      assert RustyCSV.Native.parse_string_zero_copy_with_config(@multi_csv, [<<44>>, <<59>>], 34) ==
               @multi_expected
    end
  ...
  describe "multi-byte separator" do
    ...
    test "parse_string_with_config accepts multi-byte binary separator" do
      assert RustyCSV.Native.parse_string_with_config(@double_colon_csv, "::", 34) ==
               @double_colon_expected
    end

    test "parse_string_fast_with_config accepts multi-byte binary separator" do
      assert RustyCSV.Native.parse_string_fast_with_config(@double_colon_csv, "::", 34) ==
               @double_colon_expected
    end

    test "parse_string_indexed_with_config accepts multi-byte binary separator" do
      assert RustyCSV.Native.parse_string_indexed_with_config(@double_colon_csv, "::", 34) ==
               @double_colon_expected
    end

    test "parse_string_parallel_with_config accepts multi-byte binary separator" do
      assert RustyCSV.Native.parse_string_parallel_with_config(@double_colon_csv, "::", 34) ==
               @double_colon_expected
    end

    test "parse_string_zero_copy_with_config accepts multi-byte binary separator" do
      assert RustyCSV.Native.parse_string_zero_copy_with_config(@double_colon_csv, "::", 34) ==
               @double_colon_expected
    end
  ...
  describe "binary escape" do
    ...
    test "parse_string_with_config accepts binary escape for quoting" do
      csv = "\"hello\",world\n"
      assert RustyCSV.Native.parse_string_with_config(csv, 44, <<34>>) == [["hello", "world"]]
    end
  ...
  describe "multi-byte escape" do
    test "parse_string_with_config handles multi-byte escape" do
      csv = "$$hello$$,world\n"
      assert RustyCSV.Native.parse_string_with_config(csv, 44, "$$") == [["hello", "world"]]
    end

    test "parse_string_with_config handles doubled multi-byte escape" do
      csv = "$$val$$$$ue$$,other\n"
      assert RustyCSV.Native.parse_string_with_config(csv, 44, "$$") == [["val$$ue", "other"]]
    end
  end
  ...
  describe "invalid separator" do
    test "empty binary separator raises ArgumentError" do
      assert_raise ArgumentError, fn ->
        RustyCSV.Native.parse_string_with_config(@csv, <<>>, 34)
      end
    end
    ...
    test "empty escape raises ArgumentError" do
      assert_raise ArgumentError, fn ->
        RustyCSV.Native.parse_string_with_config(@csv, 44, <<>>)
      end
    end
  end
end
